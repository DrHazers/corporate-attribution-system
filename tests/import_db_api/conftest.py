...
from backend.analysis.ownership_penetration import AUTO_NOTE  # noqa: E402
...
def _pick_sample_ids() -> dict[str, int]:
    ...
    try:
        ...
        with_auto_country = (
            ...
            .filter(CountryAttribution.notes == AUTO_NOTE)
        ...
        return {
            ...
            "with_auto_country": int(with_auto_country[0]),
